...
export class DecisionWidget extends Widget {
    ...
    public drawSelf() {
        ...
        this._context.moveTo(width / 2 + 2, 2);
        this._context.lineTo(width, height / 2 + 2);
        this._context.lineTo(width / 2 + 2, height);
        this._context.lineTo(2, height / 2 + 2);
        this._context.lineTo(width / 2 + 2, 2);
